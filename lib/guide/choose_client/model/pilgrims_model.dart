...
//
//     final pilgrimsModel = pilgrimsModelFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

PilgrimsModel pilgrimsModelFromJson(String str) => PilgrimsModel.fromJson(json.decode(str));

String pilgrimsModelToJson(PilgrimsModel data) => json.encode(data.toJson());
...
class PilgrimsModel {
  ...
  PilgrimsModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class Notes {
  ...
  Notes({this.id, this.guide, this.content, this.created, this.pilgrim});
